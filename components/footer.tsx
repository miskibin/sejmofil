...
import { siDiscord, siYoutube, siTiktok, siGithub } from "simple-icons";

// Helper to render a simple-icons icon
const SimpleIcon = ({
  icon,
  size = 20,
}: {
...
const socialLinks = [
  ...
  },
  {
    ...
    icon: <SimpleIcon icon={siDiscord} size={20} />,
  },
  {
    name: "youtube",
    url: SOCIAL_LINKS.YOUTUBE,
    icon: <SimpleIcon icon={siYoutube} size={20} />,
  },
  {
    name: "tiktok",
    url: SOCIAL_LINKS.TIKTOK,
    icon: <SimpleIcon icon={siTiktok} size={20} />,
  },
  {
    name: "github",
    url: SOCIAL_LINKS.GITHUB,
    icon: <SimpleIcon icon={siGithub} size={20} />,
  },
];
