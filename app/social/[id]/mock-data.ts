export const mockVotings = [
  {
    ...
    votingNumber: 1,
    topic:
      'Głosowanie nad przyjęciem w całości projektu ustawy o zmianie zasad przyznawania azylu',
    result: 'Accepted',
    yes: 278,
    no: 164,
    abstained: 12,
  ...
  },
  {
    ...
    votingNumber: 5,
    topic:
      'Poprawka dotycząca utworzenia specjalnej komisji ds. weryfikacji wniosków azylowych',
    result: 'Rejected',
    yes: 190,
    no: 220,
    abstained: 15,
...
export const mockStatements = [
  {
    ...
    statement_ai: {
      summary_tldr:
        'Przedstawiono szczegółową analizę wpływu proponowanych zmian na system azylowy, wskazując na potencjalne zagrożenia i korzyści...',
      citations: [
  ...
  },
  {
    ...
    statement_ai: {
      summary_tldr:
        'Proponowane zmiany w prawie migracyjnym są niewystarczające i mogą prowadzić do poważnych konsekwencji dla bezpieczeństwa kraju.',
      citations: [
        'Według najnowszych danych, które przedstawił minister, liczba wniosków o azyl wzrosła o 300% w ostatnim kwartale...',
      ],
  ...
  },
  {
    ...
    statement_ai: {
      summary_tldr:
        'Ustawa wprowadza kluczowe zabezpieczenia i usprawnia proces weryfikacji osób przekraczających granicę.',
      citations: [
        'Nowe procedury pozwolą na skrócenie czasu oczekiwania na decyzję o 60%...',
      ],
