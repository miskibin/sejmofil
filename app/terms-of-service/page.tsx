      ...
      <CardContent className="space-y-6">
        <section>
          ...
          <p className="text-muted-foreground">
            Sejmofil jest niekomercyjnym serwisem internetowym służącym do
            analizy i prezentacji danych z posiedzeń Sejmu RP. Korzystanie z
            serwisu jest bezpłatne i oznacza akceptację niniejszego regulaminu.
          </p>
        </section>
